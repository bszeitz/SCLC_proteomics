...
#save(perf.plsda.Both, file="RData/perf_plsda_CPimp.RData")
load("RData/perf_plsda_CPimp.RData")
...
```{r }
pdf(file="Figures/PLSDA_performance_plot_CP.pdf",width = 7, height = 5)
plot(perf.plsda.Both, col = color.mixo(5:7), sd = TRUE, legend.position = "horizontal")
dev.off()
...
#save(tune.splsda.Both, file="RData/tune_splsda_CPimp.RData")
load("RData/tune_splsda_CPimp.RData")
```
...
```{r }
pdf(file="Figures/sPLSDA_components12_CP.pdf",width = 7, height = 5)
plotIndiv(splsda.Both, comp = c(1,2),
          group = Y, ind.names = FALSE, 
          ellipse = TRUE, legend = TRUE,
          title = 'sPLS-DA, comp 1 & 2')
...
#                   progressBar = T) 
#save(perf.Both, file="RData/splsda_perf_Both_CPimp.RData")
load("RData/splsda_perf_Both_CPimp.RData")
...
```{r }
pdf(file="Figures/sPLSDA_classification_perf_CP.pdf",width = 7, height = 5)
plot(perf.Both, col = color.mixo(5))
dev.off()
```
...
export_with_rowname(Both.comp.selected, "Files/sPLSDA_results_CP",F)
