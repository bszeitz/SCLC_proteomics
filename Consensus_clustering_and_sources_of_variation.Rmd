...
SD.CM.imp <- apply(CM.expr.imp.secr, 1, sd, na.rm=TRUE)
CM.expr.imp.secr.sd <- CM.expr.imp.secr[SD.CM.imp > 1.25,]
```
...
```{r }
save(CP.expr.imp.sd,CM.expr.imp.secr.sd, Annot, file="RData/CP_CM_PCAs_PVCAs.RData")
